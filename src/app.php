...
foreach (explode("\n", file_get_contents($argv[1])) as $row) {
    ...
    $binResults = $client->request('GET', 'https://lookup.binlist.net/' .$value[0])->getBody();
    ...
    $rate = @json_decode($client->request('GET', 'https://lookup.binlist.net/' .$value[0])->getBody(), true)['rates'][$value[2]];
